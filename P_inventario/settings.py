...
ROOT_URLCONF = 'P_inventario.urls'
...
WSGI_APPLICATION = 'P_inventario.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'Mayte$matriculadb',  # normalmente igual que tu usuario
        'USER': 'Mayte',                  # tu nombre de usuario en PythonAnywhere
        'PASSWORD': 'pararapapa_pararapachin',
        'HOST': 'Mayte.mysql.pythonanywhere-services.com',
        'PORT': '3306',
        'OPTIONS': {
